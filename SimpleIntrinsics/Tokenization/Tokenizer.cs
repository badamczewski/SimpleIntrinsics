...
namespace SimpleIntrinsics.CommentTokenization
{
    public class Tokenizer
    {
        ...
        public List<Token> Tokenize(string program, char newLineChar = '\n')
        {
            ...
            while (i < input.Length)
            {
                ...
                {
                    IgnoreLine(ref i, ref line, ref offset);
                }
        ...
        private void IgnoreLine(ref int i, ref int line, ref int position)
        {
            int start = i;
            int startPosition = position;
        ...
        private OperatorToken ParseOperator(ref int i, ref int line, ref int position)
        {
            ...
            var result = new OperatorToken() { Input = input.Slice(start, i - start), Line = line, Position = startPosition };
            return result;
        }
